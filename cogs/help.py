...
class NextButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        cmds = filter_user_commands(
            self.view_ref.categories[self.view_ref.category], interaction
        )
        ...
        await interaction.response.edit_message(
            embed=embed,
            view=HelpView(self.view_ref.bot, interaction, self.view_ref.category, new_page)
        )
